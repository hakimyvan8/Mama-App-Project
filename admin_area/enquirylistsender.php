...
$cart = $con->prepare("SELECT id,orderid,to_id,from_id,msg,sentat,receiverName,receiverPhone,senderName,senderNumber FROM messages WHERE from_id = $user_id");
$cart ->execute();
