...
import com.igor.mamba.User.driverordercompadapter;
import com.igor.mamba.User.driverorderrouteadapter;
...
public class Driverenroute extends AppCompatActivity {

    driverorderrouteadapter cartAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driverenroute);
    ...
    private void loadData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.getenrouteorder, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    cartAdapter = new driverorderrouteadapter( Driverenroute.this,orderList);
