...
public class DriverComplete extends AppCompatActivity {
    ...
    driverordercompadapter cartAdapter;
    ...
    private void loadData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.getdeliveredorder, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    cartAdapter = new driverordercompadapter( DriverComplete.this,orderList);
