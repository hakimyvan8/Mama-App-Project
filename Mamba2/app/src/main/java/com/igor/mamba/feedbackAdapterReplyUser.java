...
public class feedbackAdapterReplyUser extends RecyclerView.Adapter<feedbackAdapterReplyUser.ViewHolder> {
    ...
    public feedbackAdapterReplyUser(Context context, List<enquiryDriverModel> messages) {
