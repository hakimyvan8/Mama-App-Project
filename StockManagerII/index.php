    ...
    <div id="wrapper"><!-- wrapper Starts -->
        ...
        <div id="page-wrapper"><!-- page-wrapper Starts -->
            ...
            <div class="container-fluid"><!-- container-fluid Starts -->
                ...
                if(isset($_GET['delete_itemDetail'])){

                    include("delete_itemDetail.php");
                ...
                if(isset($_GET['edit_itemDemand'])){
                    ...
                    include("edit_itemDemand.php");

                }


                if(isset($_GET['view_itemDemand'])){

                    include("view_itemDemand.php");
                ...
                if(isset($_GET['edit_itemCat'])){

                    include("edit_itemCat.php");

                }

                if(isset($_GET['delete_itemCat'])){

                    include("delete_itemCat.php");
